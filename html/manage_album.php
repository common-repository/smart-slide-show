...
?>
<?php if(isset($gsss->messages['upload']) && is_array($gsss->messages['upload']) && count($gsss->messages['upload']) > 0): ?>
<div class="updated">
<p class="">
<?php foreach($gsss->messages['upload'] as $msg): ?>
	<span><?php print $msg; ?></span><br/>
<?php endforeach;?>
</p>
</div>
<?php endif; ?>
<script type="text/javascript">var sss_current_album_id = <?php print $album['album_id']; ?>;</script>
<div class="dataTable_wrapper">
	<div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix">
		...
		<?php sss_get_table_actions(array('sss_bulk_delete_images' => 'Delete', 
											'sss_bulk_disable_images' => 'Disable', 
											'sss_bulk_enable_images' => 'Enable')); ?>
	</div>
	...
	<tbody>
	<?php require_once SSS_PLUGIN_DIR . '/html/images_rows.php'; ?>
	</tbody>
	</table>
...
<div id="single_upload" class="tab_content">
	<form id="single_upload_form" action="" method="post" enctype="multipart/form-data">
		<input type="hidden" name="task" value="sss_single_image_upload" />
...
-->
	...
	var sss_upload_dir = "<?php  /* add the replace "\\" to work on windows server */  print str_replace("\\","/",sss_get_album_dir($album['album_id'])); ?>";
	var sss_secw = "<?php 
	global $wpdb;
	$query = "SELECT txt FROM {$wpdb->prefix}sss_misc WHERE ione=1 AND itwo=1 AND ithree=1 LIMIT 1";
